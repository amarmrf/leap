...
class Evaluate:
    ...
    def evaluate(self) -> None:
        ...
        NUM_ITERATIONS = 5  # Added this constant
            ...
            for i in tqdm(range(start_index, dataset_size), desc="Evaluation"):
                ...
                for iteration in range(NUM_ITERATIONS):
                    ...
                    trace_info = {
                        ...
                        "iteration": iteration + 1,  # Added iteration number
                        "task_id": batch.get('task_id', None),
                        "problem": batch.get('prompt', ''),
...
def main():
    ...
    try:
        ...
        val_file = os.path.join(config.data_path, 'leap_eval_train.json')
